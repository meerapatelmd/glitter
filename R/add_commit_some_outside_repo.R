...
add_commit_some_outside_repo <-
        function(path_to_local_repo, filenames, commit_message, description = NULL) {
                return_msg_01 <- git_add_some_outside_repo(path_to_local_repo = path_to_local_repo,
                                          filenames = filenames)
                return_msg_02 <- git_commit_outside_repo(path_to_local_repo = path_to_local_repo,
